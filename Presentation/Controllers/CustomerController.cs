    ...
    public class CustomerController : BaseController
    {
        ...
        public IActionResult index()
        {
            ...
            else
            {
                ...
                List<Entities.Team> entityListTeam = obj.getAllTeamMembers();
                var obj2 = new RacoonProvider.Services();
                List<Entities.Service> entityListServices = obj2.getAllServices();
                var a = new IndexViewModel();
                a.T = entityListTeam;
                a.S = entityListServices;
                return View("index", a);
            }
        }
        // index >>>
